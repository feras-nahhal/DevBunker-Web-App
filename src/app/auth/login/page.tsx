    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-2 h-screen">
        ...
        <div className="flex flex-col items-center justify-center px-6">
          <h3 className="text-white font-bold text-[32px] leading-[48px] font-barlow text-center">Hi, Welcome back</h3>
          <p className="mt-2 text-[#434343] font-['Public Sans'] text-[16px] leading-[24px] text-center">More effectively with optimized workflows.</p>
        </div>
            ...
            <div className="w-[404px] h-[355px] flex flex-col p-6 gap-6 bg-white/[0.05] rounded-xl">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  ...
                  <Link href="/auth/register" className="text-green-500 font-medium hover:text-green-400 transition-colors">Get started</Link>
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex justify-end">
                  <Link href="/auth/password-reset" className="flex items-center gap-2 text-sm text-white hover:text-green-400 transition-colors">Forgot password?</Link>
                </div>
