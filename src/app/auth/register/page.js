    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-2 h-screen">
        ...
        <div className="flex items-center justify-center px-6">
          {/* Outer Glass Box */}
          <div
            className="w-[420px] h-[421px] flex items-center justify-center 
              bg-white/[0.05] border border-white/10 
              backdrop-blur-[20px] rounded-2xl shadow-lg"
          >
            {/* Inner Box */}
            <div
              className="w-[404px] h-[405px] flex flex-col p-6 gap-6 
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-full border border-gray-700 bg-transparent 
                        px-4 py-2 pr-10 text-white placeholder-gray-500 focus:border-green-500 
                        focus:ring-2 focus:ring-green-600/50"
                    />
                    <button
                      type="button"
      ...
      {showPopup && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/50 z-50">
          <div
            className="w-[400px] h-[200px] flex flex-col items-center justify-center 
              bg-white/[0.05] border border-white/10 
          ...
          >
            ...
            <button
              ...
              className="relative w-[120px] h-[36px] rounded-full 
                bg-white/[0.05] border border-white/10 
                shadow-[inset_0_0_4px_rgba(239,214,255,0.25)]
                backdrop-blur-[10px] text-white font-bold text-sm 
                flex items-center justify-center transition hover:scale-[1.02]
