    ...
    <div className="dashboard">
      ...
      <div className={`main-content ${sidebarCollapsed ? "collapsed" : ""}`}>
        ...
        <div className="explore-container">
                                    ...
                                    {isFilterMenuOpen && (
                                      <div
                                        ...
                                        style={{
                                          ...
                                          gap: "12px",
                                          position: "absolute",
                                          width: "min(600px, 90vw)", // NEW: Responsive width (max 600px, but 90% of viewport on small screens)
                                          top: "100%",
                                          right: 0,
          ...
          <BookmarksGrid type={filters.type as "all" | "post" | "mindmap" | "research"} searchQuery={searchQuery} filters={filters} selectedContentId={selectedContentId} />
        </div>
      </div>
    </div>
  );
