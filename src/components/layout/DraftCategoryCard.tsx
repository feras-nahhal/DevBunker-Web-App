...
<div className="card-header relative">
  <div className="header-stack flex items-center justify-center w-full">
    <div className="header-text text-center">
      <div className="title text-left">Request tag or Category</div>
    </div>
    <button
      onClick={onClose}
      className="close-btn absolute  right-0 w-[20px] h-[20px] flex items-center justify-center rounded-full bg-white text-black font-bold text-xs hover:bg-gray-200 transition"
    >
      ×
    </button>
      ...
      <style jsx>{`
        ...
        .header-stack {
          ...
          flex-direction: row;
          align-items: center;
          justify-content: space-between; /* Added to space title and close button */
          padding: 0px;
          gap: 16px;
          width: 567px;
          height: 28px;
        ...
        .textfield-section {
          ...
          width: 258px;
          height: 100px;
          gap: 7.5px; /* Gap between input and button */
          flex: none;
          order: 1;
          align-self: stretch;
          flex-grow: 0;
